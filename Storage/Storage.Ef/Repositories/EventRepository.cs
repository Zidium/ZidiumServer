    ...
    internal class EventRepository : IEventRepository
    {
        ...
        */
            ...
            using (var contextWrapper = _storage.GetContextWrapper())
            {
                ...
                using (var connection = contextWrapper.Context.CreateConnection())
                {
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        var query = $"DELETE FROM {contextWrapper.Context.FormatTableName("EventParameters")} WHERE {contextWrapper.Context.FormatColumnName("EventId")} IN ({objectQuery.ToTraceString()})";
            ...
            using (var contextWrapper = _storage.GetContextWrapper())
            {
                ...
                using (var connection = contextWrapper.Context.CreateConnection())
                {
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        var query = $"UPDATE {contextWrapper.Context.FormatTableName("Events")} SET {contextWrapper.Context.FormatColumnName("LastStatusEventId")} = NULL WHERE {contextWrapper.Context.FormatColumnName("LastStatusEventId")} IN({objectQuery.ToTraceString()})";
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        var query = $"DELETE FROM {contextWrapper.Context.FormatTableName("Events")} WHERE {contextWrapper.Context.FormatColumnName("Id")} IN({objectQuery.ToTraceString()})";
            ...
            using (var contextWrapper = _storage.GetContextWrapper())
            {
                ...
                using (var connection = contextWrapper.Context.CreateConnection())
                {
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        var query = $"DELETE FROM {contextWrapper.Context.FormatTableName("EventStatuses")} WHERE {contextWrapper.Context.FormatColumnName("EventId")} IN ({objectQuery.ToTraceString()})";
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        var query = $"DELETE FROM {contextWrapper.Context.FormatTableName("EventStatuses")} WHERE {contextWrapper.Context.FormatColumnName("StatusId")} IN ({objectQuery.ToTraceString()})";
            ...
            using (var contextWrapper = _storage.GetContextWrapper())
            {
                ...
                using (var connection = contextWrapper.Context.CreateConnection())
                {
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        var query = $"UPDATE {contextWrapper.Context.FormatTableName("MetricHistory")} SET {contextWrapper.Context.FormatColumnName("StatusEventId")} = NULL WHERE {contextWrapper.Context.FormatColumnName("StatusEventId")} IN ({objectQuery.ToTraceString()})";
        ...
        public int DeleteNotifications(EventCategory[] categories, int maxCount, DateTime toDate)
        {
            using (var contextWrapper = _storage.GetContextWrapper())
            {
                ...
                using (var connection = contextWrapper.Context.CreateConnection())
                {
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        var objectQuery = (ObjectQuery)((IObjectContextAdapter)contextWrapper.Context).ObjectContext.CreateObjectSet<DbNotification>()
                            .Where(t => subQuery.Contains(t.EventId)).Select(t => t.Id);

                        command.CommandTimeout = 0;

                        var query = $"DELETE FROM {contextWrapper.Context.FormatTableName("NotificationsHttp")} WHERE {contextWrapper.Context.FormatColumnName("NotificationId")} IN ({objectQuery.ToTraceString()})";
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        var query = $"DELETE FROM {contextWrapper.Context.FormatTableName("LastComponentNotifications")} WHERE {contextWrapper.Context.FormatColumnName("NotificationId")} IN ({objectQuery.ToTraceString()})";
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        var query = $"DELETE FROM {contextWrapper.Context.FormatTableName("Notifications")} WHERE {contextWrapper.Context.FormatColumnName("EventId")} IN ({objectQuery.ToTraceString()})";
            ...
            using (var contextWrapper = _storage.GetContextWrapper())
            {
                ...
                using (var connection = contextWrapper.Context.CreateConnection())
                {
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        ...
                        var query = $"DELETE FROM {contextWrapper.Context.FormatTableName("ArchivedStatuses")} WHERE {contextWrapper.Context.FormatColumnName("EventId")} IN ({objectQuery.ToTraceString()})";
                        command.CommandText = query;
        ...
        private IQueryable<Guid> GetEventsSubQuery(EventCategory[] categories, DateTime actualDate, int maxCount)
        {
            using (var contextWrapper = _storage.GetContextWrapper())
            {
                return ((IObjectContextAdapter)contextWrapper.Context).ObjectContext.CreateObjectSet<DbEvent>()
