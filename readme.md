...
- Установит секретный ключ XXX (обязательно поменяйте его в конфигурационном файле)
- Создаст пользователя с логином Admin и паролем 12345. Обязательно смените пароль в личном кабинете!
...
Чтобы Zidium Server Monitor обращался к вашему сервису Api, а не к облачному, в файле настроек Zidium.config в разделе access в атрибуте url укажите укажите адрес приложения Dispatcher, например, http://localhost:60000.
