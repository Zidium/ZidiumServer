...
{
    public static class SystemTariffLimit
    {
        /// <summary>
        ...
        /// Бонус за друга
        /// </summary>
        public static readonly TariffLimitForAdd Friend = new TariffLimitForAdd()
        {
        ...
        /// </summary>
        public static readonly TariffLimitForAdd TestBonus = new TariffLimitForAdd()
        {
