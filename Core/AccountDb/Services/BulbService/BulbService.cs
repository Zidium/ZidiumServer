...
namespace Zidium.Core.AccountsDb
{
    public class BulbService : IBulbService
    {
        ...
        private IEventCacheReadObject CreateOrUpdateStatusEvent(Guid accountId, BulbCacheWriteObject data)
        {
            if (data == null)
            {
        ...
        private IEventCacheReadObject AddStatusEvent(Guid accountId, BulbCacheWriteObject data, Guid ownerId)
        {
            ...
            using (var transaction = _storage.BeginTransaction())
            {
                ...
                if (oldStatus != null)
                {
                    ...
                    using (var oldStatusCache = AllCaches.Events.GetForWrite(oldStatus.Id, accountId))
                    {
        ...
        private void UpdateLastStatusId(Guid accountId, Guid eventId, IBulbCacheReadObject bulb)
        {
        ...
        private void ChangeStatus(BulbSignal signal, BulbCacheWriteObject data)
        {
            ...
            var ownerId = data.GetOwnerId();
            AddStatusEvent(signal.AccountId, data, ownerId);
        }
        ...
        /*
        private Guid? GetParentStatusId(Guid accountId, Bulb data)
        {
        ...
        */
        ...
        public void CalculateByChilds(Guid accountId, Guid statusId, Guid[] childs)
        {
            var processDate = DateTime.Now;
            var request = new AccountCacheRequest()
            {
        ...
        public Guid CreateBulb(Guid accountId,
            DateTime createDate,
