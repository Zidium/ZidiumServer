...
namespace Zidium.Core.AccountsDb
{
    public class SubscriptionService : ISubscriptionService
    {
        ...
        public SubscriptionForRead CreateSubscription(Guid accountId, CreateSubscriptionRequestData requestData)
        {
            if (requestData == null)
            {
        ...
        public void UpdateSubscription(Guid accountId, UpdateSubscriptionRequestData requestData)
        {
            if (requestData == null)
            {
                throw new ParameterRequiredException("Request.Subscription");
        ...
        private void SetSubscriptionEnable(Guid accountId, Guid subscriptionId, bool enable)
        {
        ...
        public void SetSubscriptionEnable(Guid accountId, SetSubscriptionEnableRequestData requestData)
        {
            if (requestData == null)
            {
                throw new ParameterRequiredException("Request.Data");
            }
            SetSubscriptionEnable(accountId, requestData.Id, true);
        }

        public void SetSubscriptionDisable(Guid accountId, SetSubscriptionDisableRequestData requestData)
        {
            if (requestData == null)
            {
                throw new ParameterRequiredException("Request.Data");
            }
            SetSubscriptionEnable(accountId, requestData.Id, false);
        }
        ...
        public SubscriptionForRead CreateDefaultForUser(Guid accountId, Guid userId)
        {
            var lockObj = LockObject.ForAccount(accountId);
