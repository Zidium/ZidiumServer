...
namespace Zidium.Core.AccountsDb
{
    public class EventTypeService : IEventTypeService
    {
        ...
        public EventTypeForRead GetOneById(Guid eventTypeId, Guid accountId)
        {
            return _storage.EventTypes.GetOneById(eventTypeId);
        }

        public EventTypeForRead GetOrCreate(EventTypeForAdd eventType, Guid accountId)
        {
        ...
        public EventTypeForRead GetOneBySystemName(Guid accountId, string systemName)
        {
        ...
        public void Update(Guid accountId, UpdateEventTypeRequestData data)
        {
            ...
            {
                componentService.CalculateEventsStatus(accountId, id);
            }
