...
namespace Zidium.Core.Caching
{
    public class BulbCacheWriteObject : CacheWriteObjectBase<AccountCacheRequest, BulbCacheResponse, IBulbCacheReadObject, BulbCacheWriteObject>, IBulbCacheReadObject
    {
        ...
        public Guid? GetParentId()
        {
            ...
            {
                if (UnitTestId == null)
                    throw new Exception($"EventCategory is UnitTestStatus, but UnitTestId is null, id: {Id}");
            ...
            {
                if (MetricId == null)
                    throw new Exception($"EventCategory is MetricStatus, but MetricId is null, id: {Id}");
        ...
        public static BulbCacheWriteObject Create(BulbForRead data)
        {
            if (data == null)
            {
                return null;
