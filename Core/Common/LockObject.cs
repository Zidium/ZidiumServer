...
namespace Zidium.Core.Common
{
    ...
    public class LockObject
    {
        ...
        public static object ForAccount(Guid accountId)
        {
            return _accountLocks.Get(accountId);
        }

        /// <summary>
        /// Возвращает объект блокировки для типа события
        /// </summary>
        public static object ForEventType(Guid accountId, string systemName)
        {
            var key = systemName + accountId;
