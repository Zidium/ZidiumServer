...
namespace Zidium.Agent.Tests
{
    public class CreateNotificationTests : BaseTest
    {
        ...
        public void SubscriptionObjectTest()
        {
            ...
            var user1 = TestHelper.CreateTestUser(displayName: "user1");
            var user2 = TestHelper.CreateTestUser(displayName: "user2");
            var user3 = TestHelper.CreateTestUser(displayName: "user3");
            ...
            {
                var subscriptionId = dispatcher.CreateSubscription(new CreateSubscriptionRequestData()
                {
                    UserId = user.Id,
                ...
                dispatcher.UpdateSubscription(new UpdateSubscriptionRequestData()
                {
                    Id = subscriptionId,
                    IsEnabled = true,
            ...
            var subscription2Id = dispatcher.CreateSubscription(new CreateSubscriptionRequestData()
            {
                UserId = user2.Id,
            ...
            dispatcher.CreateSubscription(new CreateSubscriptionRequestData()
            {
                UserId = user3.Id,
                ComponentTypeId = component.Type.Info.Id,
                Channel = SubscriptionChannel.Email,
            ...
            var subscription3Id = dispatcher.CreateSubscription(new CreateSubscriptionRequestData()
            {
                UserId = user3.Id,
            ...
            var notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Success, component.Info.Id, SubscriptionChannel.Email);
            ...
            notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Warning, component.Info.Id, SubscriptionChannel.Email);
            ...
            notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Alarm, component.Info.Id, SubscriptionChannel.Email);
        ...
        public void NotificationByChannelTest(SubscriptionChannel channel)
        {
            ...
            var dispatcher = TestHelper.GetDispatcherClient();
            var subscriptionResponse = dispatcher.CreateSubscription(new CreateSubscriptionRequestData()
            {
                UserId = user.Id,
                Object = SubscriptionObject.ComponentType,
            ...
            using (var context = account.GetDbContext())
            {
                ...
                var notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Alarm, component.Id, channel);
                Assert.Equal(1, notifications.Count);
        ...
        public void ForDisabledComponentTest()
        {
            ...
            // Отключим компонент
            dispatcher.SetComponentDisable(new SetComponentDisableRequestDataDto()
            {
                ComponentId = component.Id
            });
            ...
            {
                var notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Alarm, component.Id, SubscriptionChannel.Email);
                Assert.Equal(0, notifications.Count);
            }
        ...
        public void SameColorTest()
        {
            ...
            var notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Warning, component.Info.Id, SubscriptionChannel.Email);
            Assert.Equal(0, notifications.Count);
            ...
            notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Alarm, component.Info.Id, SubscriptionChannel.Email);
            Assert.Equal(1, notifications.Count);
            notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Success, component.Info.Id, SubscriptionChannel.Email);
            Assert.Equal(1, notifications.Count);
        }
        ...
        public void HttpNotificationTest()
        {
            ...
            var notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Alarm, component.Id, SubscriptionChannel.Http);
            Assert.Equal(1, notifications.Count);
        ...
        public void PreviousStatusTest()
        {
            ...
            var notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Alarm, component.Info.Id, SubscriptionChannel.Email);
            Assert.Equal(1, notifications.Count);
            var notification = notifications.Single();
            Assert.Equal(NotificationReason.NewImportanceStatus, notification.Reason);
            ...
            processor.Process(component.Info.Id, user.Id);
            notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Unknown, component.Info.Id, SubscriptionChannel.Email);
            Assert.Equal(0, notifications.Count);
        ...
        public void NoNotificationForNewContactTest()
        {
            ...
            // Старые уведомления не должны приходить на новые контакты
            notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Alarm, component.Id, SubscriptionChannel.Email);
            Assert.Equal(0, notifications.Count);
        }
        ...
        public void NotifyBetterStatusTest()
        {
            ...
            var sendUnitTestResult = dispatcher.SendUnitTestResult(new SendUnitTestResultRequestDataDto()
            {
            ...
            // Отправим зелёную проверку
            sendUnitTestResult = dispatcher.SendUnitTestResult(new SendUnitTestResultRequestDataDto()
            {
                UnitTestId = unittest.Id,
            ...
            notifications = TestHelper.SendSubscriptionNotifications(EventImportance.Success, component.Id, SubscriptionChannel.Email);
            Assert.Equal(0, notifications.Count);
        ...
        public void SendIntervalInsideTest()
        {
            ...
            var userSettingService = new UserSettingService(TestHelper.GetStorage());
