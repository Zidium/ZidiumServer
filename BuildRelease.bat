...
"%ZIDIUM_MSBUILD%" /t:Services\DispatcherHttpService Zidium.sln /p:Configuration="Publish" /v:minimal /p:DeployOnBuild=true /p:PublishProfile=CreateRelease.pubxml
...
"%ZIDIUM_MSBUILD%" /t:Api\1_0\ApiHttpService_1_0 Zidium.sln /p:Configuration="Publish" /v:minimal /p:DeployOnBuild=true /p:PublishProfile=CreateRelease.pubxml
...
"%ZIDIUM_MSBUILD%" /t:UserAccount_AddIn Zidium.sln /p:Configuration="Publish" /v:minimal /p:SolutionDir="%cd%"\

"%ZIDIUM_MSBUILD%" /t:UserAccount Zidium.sln /p:Configuration="Publish" /v:minimal /p:DeployOnBuild=true /p:PublishProfile=CreateRelease.pubxml
