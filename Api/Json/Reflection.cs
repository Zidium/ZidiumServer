...
namespace Zidium.Api.JsonClasses
{
    ...
    internal sealed class Reflection
    {
        ...
        public Type[] GetGenericArguments(Type t)
        {
            ...
            {
                tt = t.GetTypeInfo().GetGenericArguments();
        ...
        public Dictionary<string, myPropInfo> Getproperties(Type type, string typename, bool customType)
        {
            ...
            else
            {
                ...
                PropertyInfo[] pr = type.GetTypeInfo().GetProperties(BindingFlags.Public | BindingFlags.Instance | BindingFlags.Static);
                ...
                FieldInfo[] fi = type.GetTypeInfo().GetFields(BindingFlags.Public | BindingFlags.Instance | BindingFlags.Static);
            ...
            try
            {
                ...
                else
                {
                    if (objtype.GetTypeInfo().IsClass)
                    {
                        ...
                        ilGen.Emit(OpCodes.Newobj, objtype.GetTypeInfo().GetConstructor(Type.EmptyTypes));
        ...
        internal Getters[] GetGetters(Type type, bool ShowReadOnlyProperties, List<Type> IgnoreAttributes)//JSONParameters param)
        {
            ...
            PropertyInfo[] props = type.GetTypeInfo().GetProperties(BindingFlags.Public | BindingFlags.Instance | BindingFlags.Static);
            ...
            FieldInfo[] fi = type.GetTypeInfo().GetFields(BindingFlags.Instance | BindingFlags.Public | BindingFlags.Static);
            foreach (var f in fi)
            {
                if (IgnoreAttributes != null)
                {
