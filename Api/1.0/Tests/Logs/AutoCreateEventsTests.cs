...
namespace ApiTests_1._0.Logs
{
    public class AutoCreateEventsTests : BaseTest
    {
        ...
        public void LogFatalExceptionTest()
        {
            ...
            Assert.True(events.Any(t => t.Importance == EventImportance.Alarm && t.Properties.Any(x => x.Name == "FromLog")));
        }
        ...
        public void LogErrorExceptionTest()
        {
            ...
            Assert.True(events.Any(t => t.Importance == EventImportance.Warning && t.Properties.Any(x => x.Name == "FromLog")));
        }
        ...
        public void LogInfoExceptionTest()
        {
            ...
            Assert.True(events.Any(t => t.Importance == EventImportance.Success && t.Properties.Any(x => x.Name == "FromLog")));
        }
        ...
        public void LogDebugExceptionTest()
        {
            ...
            Assert.True(events.Any(t => t.Importance == EventImportance.Unknown && t.Properties.Any(x => x.Name == "FromLog")));
        }
        ...
        public void LogAutocreateDisabledTest()
        {
            ...
            Assert.False(events.Any(t => t.Properties.Any(x => x.Name == "FromLog")));
        }
        ...
        public void LogWithPropertiesTest()
        {
            ...
            Assert.NotNull(_event);
            Assert.True(_event.Properties.Any(t => t.Name == "Test property" && t.Value.Value.ToString() == "Test value"));
        }
        ...
        public void LogNoExceptionStackTest()
        {
            ...
            var _event = events.FirstOrDefault(t => t.Importance == EventImportance.Alarm && t.Properties.Any(x => x.Name == "FromLog"));
            Assert.NotNull(_event);
            var stack = _event.Properties.FirstOrDefault(t => t.Name == ExtentionPropertyName.Stack && !string.IsNullOrEmpty(t.Value.Value.ToString()));
            Assert.NotNull(stack);
            Assert.True(stack.Value.Value.ToString().Contains("ApiTests_1._0.Logs.AutoCreateEventsTests.LogNoExceptionStackTest()"));
        }
        ...
        public void LogExceptionStackTest()
        {
            ...
            var stack = _event.Properties.FirstOrDefault(t => t.Name == ExtentionPropertyName.Stack && !string.IsNullOrEmpty(t.Value.Value.ToString()));
            Assert.NotNull(stack);
            Assert.True(stack.Value.Value.ToString().Contains("ApiTests_1._0.Logs.AutoCreateEventsTests.LogExceptionStackTest()"));
        }
