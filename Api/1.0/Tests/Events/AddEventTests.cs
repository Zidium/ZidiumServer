...
namespace ApiTests_1._0.Events
{
    public class AddEventTests : BaseTest
    {
        ...
        public void JoinTest()
        {
            ...
            var eventInfo = client.ApiService.GetEventById(result.EventId.Value);
            Assert.True(eventInfo.Data.Count > 10 * 000);
        }
        ...
        public void AddApplicationErrorTest()
        {
            ...
            Assert.Equal(errorType, eventResponse.Data.TypeSystemName);
            Assert.Equal(errorType, eventResponse.Data.TypeDisplayName);
            Assert.Equal("Сообщение", eventResponse.Data.Message);
            Assert.Equal(EventCategory.ApplicationError, eventResponse.Data.Category);
            Assert.Equal(EventImportance.Alarm, eventResponse.Data.Importance);
            Assert.Equal(1, eventResponse.Data.Count);
            ...
            Assert.Equal(EventCategory.ApplicationError, eventResponse.Data.Category);
            Assert.Equal(EventImportance.Alarm, eventResponse.Data.Importance);
            Assert.Equal(2, eventResponse.Data.Count);
        }
        ...
        public void AddApplicationErrorWithZeroJoinInterval1()
        {
            ...
            Assert.Equal(addResult.Status, AddEventStatus.Sended);
        ...
        public void AddApplicationErrorWithZeroJoinInterval2()
        {
            ...
            Assert.Equal(addResult1.Status, AddEventStatus.Sended);
            Assert.Equal(addResult2.Status, AddEventStatus.Sended);
