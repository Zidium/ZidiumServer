...
namespace ApiTests_1._0.Events
{
    ...
    public class EventVersionTests
    {
        ...
        public void JoinTest()
        {
            ...
            var response = eventData.Send();
            Assert.True(response.Success);
            var eventInfo = component.Client.ApiService.GetEventById(response.Data.EventId).Data;
            ...
            response = eventData.Send();
            eventInfo = component.Client.ApiService.GetEventById(response.Data.EventId).Data;
