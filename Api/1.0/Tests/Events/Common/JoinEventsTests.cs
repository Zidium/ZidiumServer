...
namespace ApiTests_1._0.Events
{
    public class JoinEventsTests
    {
        ...
        public void DiffVersions()
        {
            ...
            Assert.NotEqual(response3.Data.EventId, response2.Data.EventId); 
            Assert.Equal(response4.Data.EventId, response3.Data.EventId);

            // version = 1.1
            error.Version = "1.1";
            var response5 = error.Send();
            var response6 = error.Send();
            Assert.NotEqual(response5.Data.EventId, response4.Data.EventId);
            Assert.Equal(response5.Data.EventId, response6.Data.EventId);
        }
        ...
        public void DiffImportanceAdd()
        {
            ...
            var events = client.ApiService.GetEvents(new GetEventsData()
            {
