...
#if !SILVERLIGHT
                            case myPropInfoType.DataSet: throw new NotImplementedException(); /* oset = CreateDataset((Dictionary<string, object>)v, globaltypes);*/
                            case myPropInfoType.DataTable: throw new NotImplementedException(); /* oset = CreateDataTable((Dictionary<string, object>)v, globaltypes);*/
