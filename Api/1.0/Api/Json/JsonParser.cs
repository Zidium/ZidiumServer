...
namespace Zidium.Api.JsonClasses
{
    ...
    internal sealed class JsonParser
    {
        ...
        private object ParseNumber()
        {
            ...
            // check for Infinity
            if (startIndex + 8 <= json.Length && json.Substring(startIndex, 8) == "Infinity")
            {
                index += 7;
            ...
            // check for Nan
            if (startIndex + 3 <= json.Length && json.Substring(startIndex, 3) == "NaN")
            {
                index += 2;
                return double.NaN;
            }
