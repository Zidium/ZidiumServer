        ...
        where T : CheckSimpleBaseModel, new()
    {
        ...
        protected Guid SaveSimpleCheck(T model, IStorage storage)
        {
            ...
            if (model.Id.HasValue)
            {
                ...
                dispatcher.UpdateUnitTest(updateData).Check();
            ...
            else // создание проверки
            {
                ...
                if (!model.ComponentId.HasValue)
                {
                    ...
                    var createFolderResponse = dispatcher.GetOrCreateComponent(new GetOrCreateComponentRequestDataDto()
                    {
                    ...
                    var createComponentTypeResponse = dispatcher.GetOrCreateComponentType(new GetOrCreateComponentTypeRequestDataDto()
                    {
                ...
                {
                    component = dispatcher.GetComponentById(model.ComponentId.Value).Data;
                }
                ...
                dispatcher.GetOrCreateUnitTest(createUnitTestData).Check();
