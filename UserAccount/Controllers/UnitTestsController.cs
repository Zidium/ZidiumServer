...
namespace Zidium.UserAccount.Controllers
{
    ...
    public class UnitTestsController : BaseController
    {
        ...
        public ActionResult Add(Guid? componentId = null)
        {
            ...
            dispatcher.GetOrCreateUnitTestType(new GetOrCreateUnitTestTypeRequestDataDto()
            {
        ...
        public ActionResult Add(UnitTestAddModel model)
        {
            ...
            var response = client.GetOrCreateUnitTest(data);
        ...
        public ActionResult Edit(UnitTestEditModel model)
        {
            ...
            var dispatcher = GetDispatcherClient();
            var response = dispatcher.UpdateUnitTest(updateData);
            if (response.Success)
            {
        ...
        public JsonResult Enable(Guid id)
        {
            ...
            {
                var client = GetDispatcherClient();
                var response = client.SetUnitTestEnable(id);
                response.Check();
        ...
        public JsonResult Delete(Guid id, string fake)
        {
            ...
            {
                var client = GetDispatcherClient();
                client.DeleteUnitTest(id).Check();
                return GetSuccessJsonResponse();
            }
            catch (Exception exception)
            {
        ...
        public JsonResult Disable(DisableDialogPostModel model)
        {
            try
            {
                ...
                var data = new SetUnitTestDisableRequestDataDto()
                {
                    Comment = model.Comment,
                    ToDate = date,
                    UnitTestId = model.Id
                };
                client.SetUnitTestDisable(data).Check();
                return GetSuccessJsonResponse();
            }
            catch (Exception exception)
            {
        ...
        public JsonResult SetResult(UnitTestSetResultModel model)
        {
            try
            {
                var unitTest = GetStorage().UnitTests.GetOneById(model.Id);
                var client = GetDispatcherClient();
                var response = client.SendUnitTestResult(new SendUnitTestResultRequestDataDto()
                {
                    UnitTestId = unitTest.Id,
                    Result = model.Result,
        ...
        {
            var client = GetDispatcherClient();
            client.DeleteUnitTest(model.Id).Check();
            return GetSuccessJsonResponse();
        }
        ...
        {
            var client = GetDispatcherClient();
            client.SetUnitTestEnable(id).Check();
            return GetSuccessJsonResponse();
        }
        ...
        {
            var client = GetDispatcherClient();
            client.SetUnitTestNextTime(new SetUnitTestNextTimeRequestData()
            {
                UnitTestId = id,
                NextTime = Now()
            }).Check();
