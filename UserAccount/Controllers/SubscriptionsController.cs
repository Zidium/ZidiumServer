...
namespace Zidium.UserAccount.Controllers
{
    ...
    public class SubscriptionsController : BaseController
    {
        ...
        public ActionResult Edit(SubscriptionEditModel model)
        {
            ...
            var modelState = new ModelStateHelper<SubscriptionEditModel>(ModelState, HttpContext);
            ...
            try
            {
                ...
                if (model.Id == null)
                {
                    ...
                    var response = client.CreateSubscription(createData);
                    response.Check();
                ...
                else
                {
                    ...
                    var response = client.UpdateSubscription(updateData);
                    response.Check();
                }
                if (model.ModalMode)
                {
        ...
        public ActionResult Enable(string ids, bool isEnable, Guid userId, SubscriptionChannel channel)
        {
            ...
            foreach (var item in list)
            {
                ...
                var response2 = client.UpdateSubscription(new UpdateSubscriptionRequestData()
                {
                    Id = data.Id,
        ...
        public ActionResult Delete(DeleteConfirmationSmartModel model)
        {
            try
            {
                ...
                var client = GetDispatcherClient();
                var response = client.DeleteSubscription(subscription.Id);
                response.Check();
            ...
            SubscriptionChannel? channel)
        {
            ...
            model.Init(GetStorage(), HttpContext);
